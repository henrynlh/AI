...
### 4.5. Các thuật toán tìm kiếm ràng buộc: BACKTRACKING, FORWARD CHECKING, AC-3, MIN CONFLICTS
...
- **Miền giá trị**: Miền giá trị là tập hợp các màu có thể gán cho mỗi vùng. Trong chương trình mô phỏng, mỗi vùng có thể nhận một trong bốn màu: Đỏ, Vàng, Xanh lá, Xanh dương. Ban đầu, mỗi vùng đều có cùng miền giá trị.
...
- **Trạng thái**: Một trạng thái trong bài toán là tập hợp các phép gán màu hiện tại cho một số hoặc tất cả các vùng trên bản đồ. Các vùng còn lại là các vùng chưa được gán màu. Khi thuật toán tiếp tục chạy, nó sẽ chọn một vùng chưa tô và thử gán một màu hợp lệ cho vùng đó. Trạng thái hoàn chỉnh là trạng thái mà tất cả các vùng trên bản đồ đều đã được tô màu.
...
- **Solution**: Lời giải là một phép gán màu hoàn chỉnh cho toàn bộ bản đồ. Mỗi vùng được gán đúng một màu và không vi phạm ràng buộc giữa các vùng kề nhau. Trong chương trình mô phỏng, lời giải không chỉ là kết quả tô màu cuối cùng mà còn bao gồm toàn bộ quá trình thuật toán thực hiện như chọn vùng, thử màu, kiểm tra ràng buộc, cắt giảm miền giá trị và quay lui khi cần thiết.
